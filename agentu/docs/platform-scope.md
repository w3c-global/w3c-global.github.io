...
| Evidence and monitoring | Exports, independent verification, signing/retention, alerts, incident controls and tested recovery | Export signing/archive tooling built with real-cryptography tests and mocked AWS; database integrity and local restore verified; hosted signing/retention, automatic checkpoints, deployed alerts and hosted restore pending |
